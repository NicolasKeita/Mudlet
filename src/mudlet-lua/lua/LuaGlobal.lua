...
-- local module_name = "utf8"

-- print("=== Recherche du module", module_name, "===")

-- local found_path
-- for _, searcher in ipairs(package.loaders or package.searchers) do
--     local loader, path = searcher(module_name)
--     if type(loader) == "function" then
--         found_path = path or "(C built-in)"
--         break
--     end
-- end

-- if found_path then
--     print(module_name, "trouvé via:", found_path)
-- else
--     print("[MISSING] Aucun fichier trouvé via package.searchers")
-- end

-- -- Vérification manuelle de tous les chemins cpath
...
-- -- Chargement final pour confirmer
-- local ok, mod = pcall(require, module_name)
-- if ok then
--     print("require('"..module_name.."') = success, type:", type(mod))
-- else
--     print("require('"..module_name.."') = FAILED:", mod)
-- end
